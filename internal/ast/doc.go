// Package ast defines the Aril abstract syntax tree.
//
...
//
// v1 PR-B scope: only the subset needed by examples/core-language/hello/hello.aril and
// examples/core-language/fizzbuzz/fizzbuzz.aril. The full schema (sum types,
